...
complete -x -c gdm-theme -n "__fish_seen_subcommand_from backup -b; and not __fish_seen_subcommand_from $backup_actions -s set" -a 'update' -d "Update Backup"
complete -x -c gdm-theme -n "__fish_seen_subcommand_from backup -b; and not __fish_seen_subcommand_from $backup_actions -s set" -s u -d "Update Backup"
complete -x -c gdm-theme -n "__fish_seen_subcommand_from backup -b; and not __fish_seen_subcommand_from $backup_actions -s set" -a "restore" -d "Restore Backup"
complete -x -c gdm-theme -n "__fish_seen_subcommand_from backup -b; and not __fish_seen_subcommand_from $backup_actions -s set" -s r -d "Restore Backup"
